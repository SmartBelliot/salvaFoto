...
const char* ssid     = "CLARO_EA355B";  //Insira o SSID da rede
const char* password = "yntRVKVxJh"; //Insira a senha da rede

//https://script.google.com/macros/s/AKfycbx6k5xYW-CE9GFyLD05l6yKywPXURlAYqUImcVM2zDVWRUkIfBgSrDDk7-gs0KfM1RjAQ/exec

const char* myDomain = "script.google.com";
String myScript = "/macros/s/AKfycbxlC0PYyAgEPz5KqI1ZAmMQbAT4Qn_KJQcKy0GzFcNbWokgPrtmnF0yyRhtIgxdu0Ix/exec";    //Replace with your own url
...
void loop() {
boolean leitura_botao=digitalRead(botao);
...
void saveCapturedImage() {
  ...
  if (client.connect(myDomain, 443)) {
    ...
    fb = esp_camera_fb_get();  //tira a foto
